    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="入库或出库单号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'number', validatorRules.number]" placeholder="请选择入库或出库单号"></a-input>
        </a-form-item>
        ...
        <a-form-item label="入库单类别" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['cateId', validatorRules.cateId]" :trigger-change="true" dictCode="store_in_order_type" placeholder="请选择入库单类别"/>
        </a-form-item>
