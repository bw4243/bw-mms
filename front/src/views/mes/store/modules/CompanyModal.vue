  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="供应商全称" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'name', validatorRules.name]" placeholder="请输入供应商全称"></a-input>
        </a-form-item>
        ...
        <a-form-item label="企业类别" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag :triggerChange="true"  v-decorator="[ 'type', validatorRules.type]" placeholder="请选择企业类别" 
            dictCode="sys_dict_item,item_text,item_value,dict_id=1254685831755902977"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/modeling/company/add",
          edit: "/modeling/company/edit",
        }
      }
    },
    created () {
