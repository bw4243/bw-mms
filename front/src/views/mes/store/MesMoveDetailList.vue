<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('mes_move_detail')">导出</a-button>
    ...
    <mesMoveDetail-modal ref="modalForm" @ok="modalFormOk"></mesMoveDetail-modal>
  </a-card>
</template>
...
<script>
  ...
  import MesMoveDetailModal from './modules/MesMoveDetailModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'

  export default {
    name: "MesMoveDetailList",
